...
class AdaptiveDifferentialPrivacy(DataAccessDefinition):
    ...
    def __init__(self, epsilon_delta, default_access_definition=None):
        ...
        if default_access_definition is not None:
            _check_differentially_private_mechanism(default_access_definition)
        self._default_access_definition = default_access_definition

    @property
    def epsilon_delta(self):
        return self._epsilon_delta

    def apply(self, data, data_access_definition=None):
        data_access_definition_to_apply = self._get_data_access_definition(data_access_definition)
        self._private_data_epsilon_delta_access_history.append(data_access_definition_to_apply.epsilon_delta)
        ...
        if privacy_budget_exceeded:
            ...
            return data_access_definition_to_apply.apply(data)
